    ...
    return (
        <div className="flex justify-center">
            <form onSubmit={handlerSubmit}>
                ...
                <p className="w-[650px] flex justify-between items-center mb-4">แพ็กเกจ
                ...
                <p className="w-[650px] flex justify-between items-center mb-4">จำนวนลูกค้า
                ...
                <p className="w-[650px] flex justify-between items-center mb-4">จำนวนดาว
                    <input type="number" className={`${form.packet === "0" ? "border-black" : "border-[#c7c7c7]"} w-[500px] h-[36px] rounded-md border px-6`}
                        disabled={form.packet === "0" ? false : true}
